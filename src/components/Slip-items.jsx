...
function Slipitems(props)
{
    ...
    return(
      ...
      <h2 className="margin-zero py-1">
        <span className="float-start mt-1 mx-3 py-1 fs-13 ">{props.match_name}</span>
      ...
      <div className="card  px-3 bg-f9 text-color">
        <h2 className="fs-12 mt-1 mb-1 text-color"><span className="float-start mt-1 fw-bold">{props.market_category}: {props.market_lable}</span><span className=" float-end fw-bold">{props.odd}</span></h2>
      </div>
      </div>
        </>
    )
